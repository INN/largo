 ...
 *
 * The Global Navigation Menu is shown at the top of a Largo site on the top of
 * the page (varies depending on on how sticky nav is configured!).
 * It's intended for brand links like about, jobs, policies, etc. This menu
 * is also appended to the offcanvas nav menu (see partial/nav-sticky.php)
 *
